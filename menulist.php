...
<div  class="container"  style="padding-top:22px" method="post">
        ...
        <table id="table" class="table table-striped custab">
          <thead>
            <a href="registerMenu.html" class="btn btn-primary btn-xs pull-right"><b>+</b> Add new Menu</a>
           <tr bgcolor="#F0F8FF">
                     <th>Id</th>
                     <th>Name</th>
                     <th>Description</th>
...
?>
           <tr>
               ...
               <td> 
                <a href="selectMenu.php?id=<?php echo $r['id']; ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                <a href="deleteMenu.php?id=<?php echo $r['id']; ?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
              </td>
           </tr>
           <?php }?>
