...
$sql = "SELECT count(checkout.ID) as total_sales, SUM(total_amount) as sales_amount FROM checkout";
$result = $conn->query($sql);
$result = mysqli_query($conn, $sql);    

while ($row = mysqli_fetch_array($result)) {
  echo $total_sales=$row["total_sales"];
  echo $sales_amount=$row["sales_amount"];
}
  ...
  <div class="w3-container">
    ...
    <div class="w3-row">
      <div class="w3-col m2 text-center">
        <img class="w3-circle" src="img_avatar2.png" style="width:96px;height:96px">
      </div>
      <div class="w3-col m10 w3-container">
        <h4>Jemah <span class="w3-opacity w3-medium">Apr 29, 2019, 9:12 PM</span></h4>
    ...
    <div class="w3-row">
      <div class="w3-col m2 text-center">
        <img class="w3-circle" src="icon.png" style="width:96px;height:96px">
      </div>
      <div class="w3-col m10 w3-container">
        <h4>Cekelat <span class="w3-opacity w3-medium">Apr 28, 2019, 10:15 PM</span></h4>
